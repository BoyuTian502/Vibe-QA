...
function terminationLabel(reason: string): string {
  const labels: Record<string, string> = {
    ...
    RECOVERY_LIMIT: "Target recovery limit reached",
    MODEL_OUTPUT_INVALID: "Model response remained invalid",
    BROWSER_ERROR: "Browser operation failed",
    AGENT_ERROR: "Agent execution interrupted",
    SAFETY_BLOCKED: "Blocked before a sensitive action",
